...
test.describe('License Account API Tests (v4)', () => {
  ...
  test('GET Account - should return 200 with valid feature and licenseType', async ({ licenseAccountClient }) => {
  ...
  test('GET Account - should handle non-existent feature name', async ({ licenseAccountClient }) => {
  ...
  test('GET Account - should return 500 for invalid licenseType', async ({ licenseAccountClient }) => {
  ...
  test('GET Feature - should return 200 for valid account and feature', async ({ licenseAccountClient }) => {
  ...
  test('GET Feature - should handle non-existent accountId', async ({ licenseAccountClient }) => {
  ...
  test('GET Feature - should handle non-existent feature name', async ({ licenseAccountClient }) => {
  ...
  test('GET Feature - should handle invalid accountId format', async ({ licenseAccountClient }) => {
  ...
  test('GET Feature - should return 500 for invalid licenseType', async ({ licenseAccountClient }) => {
  ...
  test('POST Cache Reset - should return 200 with valid userIds', async ({ licenseAccountClient }) => {
  ...
  test('GET Has Entitlement - should return 200 for valid accountId', async ({ licenseAccountClient }) => {
  ...
  test('GET Has Entitlement - should handle non-existent accountId', async ({ licenseAccountClient }) => {
  ...
  test('GET Has Entitlement - should handle invalid accountId format', async ({ licenseAccountClient }) => {
  ...
  test('GET User Entitlement - should return 200 for valid entitlement and user', async ({ licenseAccountClient }) => {
  ...
  test('GET User Entitlement - should handle non-existent entitlementId', async ({ licenseAccountClient }) => {
  ...
  test('GET User Entitlement - should handle non-existent userId', async ({ licenseAccountClient }) => {
  ...
  test('GET User Entitlement - should handle invalid entitlementId format', async ({ licenseAccountClient }) => {
    const response = await licenseAccountClient.getUserEntitlement('invalid-id!@#', TEST_USER_ID);
    const body = await response.text();
    await test.info().attach('API Response', {
      body: JSON.stringify({ status: response.status(), body }, null, 2),
      contentType: 'text/plain',
  ...
  test('GET User Entitlement - should handle invalid userId format', async ({ licenseAccountClient }) => {
    const response = await licenseAccountClient.getUserEntitlement(TEST_ENTITLEMENT_ID, 'invalid-user!@#');
    const body = await response.text();
    await test.info().attach('API Response', {
      body: JSON.stringify({ status: response.status(), body }, null, 2),
      contentType: 'text/plain',
  ...
  test('E2E - get account, get feature, cache reset, check entitlements', async ({ licenseAccountClient }) => {
    // Step 1: Get Account
